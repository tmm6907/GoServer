...
func main() {
	...
	router.GET("/", func(ctx *gin.Context) {
		ctx.JSON(200, gin.H{
			...
			"available_endpoints": "/scores, /scores/address",
			"example_input": `
				...
				// Get list of scores by zipcode (works with and withour limit)
				curl -o out.json "localhost:8080/scores?zipcode=20001?limit=3"
				`,
